    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10"  style={{ 
        ...
        <main className="container mx-auto px-6 py-20 flex flex-col items-center text-center relative min-h-[80vh]">
          ...
          <div className="absolute top-80 left-[7%] animate-float animation-delay-300">
            <img src="/Group 27165.png" alt="" />
          </div>
          <div className="absolute top-85 right-[2%] animate-float animation-delay-500">
          ...
          App & Web Development <br /> That Powers Real <br /> Business Growth
          </h1>
...
Is Your App or Website Limiting Your Business Growth?                  </h2>
